    ...
    <div className="py-16 bg-gradient-to-br from-blue-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            Transform any recipe into an interactive cooking guide in four
            simple steps
          </motion.p>
        </div>
        ...
        >
          {steps.map((step, index) => (
            ...
            >
              <div className="bg-white rounded-xl shadow-lg p-6 h-full transform hover:scale-105 transition-all duration-300">
