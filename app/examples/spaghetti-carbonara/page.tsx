...
export default function SpaghettiCarbonaraExample() {
  return (
    <div className="flex flex-col items-center min-h-screen bg-gradient-to-br from-slate-50 to-white py-8 px-2">
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl p-8">
        <h1 className="text-3xl font-extrabold text-slate-700 mb-2 text-center">
          Spaghetti Carbonara
        </h1>
        ...
        <section className="mb-6">
          <h2 className="text-xl font-semibold text-slate-600 mb-1">
            Description
          </h2>
        ...
        <div className="mt-8 text-center">
          <Link
            href="/examples"
            className="inline-block bg-slate-600 hover:bg-slate-700 text-white font-semibold px-5 py-2 rounded-lg shadow transition-colors"
          >
            ← Back to Examples
          </Link>
        </div>
